...
public class RobotMap {
    ...
    public static RobotDrive DRIVETRAIN_ROBOT_DRIVE_4;
    public static Victor ARM_ARMMOTOR;
    public static DigitalInput ARM_LIMIT_SWITCH;
	...
	LiveWindow.addActuator("Drivetrain", "rearRightMotor", DRIVETRAIN_REARRIGHTMOTOR);
        ...
        DRIVETRAIN_ROBOT_DRIVE_4 = new RobotDrive(DRIVETRAIN_FRONTLEFTMOTOR, DRIVETRAIN_REARLEFTMOTOR,
              DRIVETRAIN_FRONTRIGHTMOTOR, DRIVETRAIN_REARRIGHTMOTOR);
	
        DRIVETRAIN_ROBOT_DRIVE_4.setSafetyEnabled(true);
        DRIVETRAIN_ROBOT_DRIVE_4.setExpiration(0.1);
        DRIVETRAIN_ROBOT_DRIVE_4.setSensitivity(0.5);
        DRIVETRAIN_ROBOT_DRIVE_4.setMaxOutput(1.0);

        ARM_ARMMOTOR = new Victor(1, 3);
	LiveWindow.addActuator("Arm", "armMotor", ARM_ARMMOTOR);
        
        ARM_LIMIT_SWITCH = new DigitalInput(1, 10);
	LiveWindow.addSensor("Arm", "Limit Switch", ARM_LIMIT_SWITCH);
