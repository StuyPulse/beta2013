...
public class Robot extends IterativeRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        autoChooser.addDefault("Grabber In Auton", new GrabberIn());
        autoChooser.addObject("Grabber Out Auton", new GrabberOut());
        ...
        SmartDashboard.putData("Drive", new DrivetrainDrive());
    }
